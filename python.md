...
## filter
Функция filter() в Python используется для фильтрации элементов из итерируемого объекта, такого как список, кортеж или строка, на основе заданного условия. Она возвращает итератор — объекты, которые удовлетворяют условию, определенному в функции.
