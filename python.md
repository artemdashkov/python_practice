...
1. Изменяемые — это те, которые можно изменять после их создания. Это значит, что вы можете изменять содержимое объекта без создания нового объекта.
2. Неизменяемые — это те, которые нельзя изменить после их создания.
...
## with
Оператор `with` ... as в Python используется для работы с контекстными менеджерами, что позволяет управлять ресурсами, обеспечивая их правильное открытие и закрытие. Это особенно полезно при работе с файлами, сетевыми соединениями и другими ресурсами, 
